(function() {
  ...
  describe('The calculator service', function() {
    ...
    describe('calculateAverageString function', function() {
      it('should call the calculateAverage and convertTimeFromMillisecondsToString functions and return the correct result', function() {
        trimmed = true;
        average = 625;
        precision = 2;
        averageString = '6.25';
        ...
        expect(Calculator.calculateAverageString(rawTimes, trimmed, precision)).toEqual(averageString);
    ...
    describe('calculateStandardDeviationString function', function() {
      it('should return the correct result', function() {
        ...
        expect(Calculator.calculateStandardDeviationString(rawTimes, trimmed, precision)).toEqual(stDevString);
